(() => {
  ...
  /*
    En celular el click del usuario tiene que iniciar
    directamente la reproducción con sonido.
  */
  vimeoPlayer.play()
    .then(() => {
    ...
    .catch(() => {
      ...
      /*
        Si el navegador móvil bloquea la primera orden,
        intentamos establecer el volumen igualmente.
      */
