...
function playVimeo() {
  ...
  vimeoPlayer.play().catch((error) => {
    console.warn('Vimeo no pudo iniciar automáticamente:', error);
  });
}
...
if (savedCountry){
  ...
  // Ya eligió país anteriormente:
  // reproducir el video apenas Vimeo esté listo.
  if (vimeoPlayer) {
  ...
  // El click del usuario permite iniciar el video inmediatamente.
  playVimeo();
});
  }
  ...
  /* =========================================================
     ...
     Reabre el mismo selector sin borrar la elección hasta que
     el usuario confirme un nuevo país.
     ========================================================= */
